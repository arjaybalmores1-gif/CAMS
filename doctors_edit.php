...
if (isset($_GET['id'])) {
    ...
    if (!$data) {
        header("Location: doctors_dashB.php?status=error&msg=Doctor+not+found.");
        exit;
    }
}
...
if (isset($_POST['update_doctor'])) {
    ...
    if (mysqli_query($conn, $sql)) {
        header("Location: doctors_dashB.php?status=success&msg=Doctor+record+updated+successfully!");
        exit();
    } else {
        header("Location: doctors_dashB.php?status=error&msg=Error+updating+record.");
        exit();
    }
}
?>
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen p-4">
    ...
    <div class="bg-white w-full max-w-lg rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div class="bg-pink-500 p-6 text-white flex justify-between items-center">
            ...
            <a href="doctors_dashB.php" class="hover:bg-pink-600 p-1 rounded-full transition-colors">
        ...
        <form method="POST" class="p-8">
            ...
            <div class="mt-8 flex gap-3">
                <a href="doctors_dashB.php" class="flex-1 px-6 py-3 border border-gray-200 text-center text-gray-500 rounded-xl font-bold text-sm hover:bg-gray-50 transition-all">Cancel</a>
